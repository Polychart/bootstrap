...
build:
	...
	@recess --compile ${BOOTSTRAP_NAMESPACED_LESS} > ${BOOTSTRAP_NAMESPACED}
...
bootstrap/js/*.js: js/*.js
	...
	recess ${BOOTSTRAP_NAMESPACED_LESS} > bootstrap/css/bootstrap-namespaced.css
	recess --compress ${BOOTSTRAP_NAMESPACED_LESS} > bootstrap/css/bootstrap-namespaced.min.css
